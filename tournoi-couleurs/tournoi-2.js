...
async function renderToday() {
  ...
  if (!info.level) {
    els.competitionArea.hidden = true;
    els.dayStatus.innerHTML = `<div class="big-day"><span class="cycle-badge">Jour ${info.cycleDay}</span></div><h2>Aucune compétition aujourd’hui</h2><p>${esc(dateLabel)} · Compétitions aux jours 2, 3, 7 et 8.</p>`;
    return;
  }
